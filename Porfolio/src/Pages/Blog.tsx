...
export function Blog () {
	return (
		<>
			...
			<div className="flex flex-wrap h-full w-full justify-center lg:justify-start lg:gap-[50px] gap-[20px] overflow-y-auto overflow-hidden lg:pb-48 pb-32 lg:px-10 px-6">
