  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-[15px] items-center justify-center h-[80%]">
        <div className="flex flex-col justify-center lg:flex-row gap-[15px]">
          <input
            className="bg-[#343838] border hover:border-[2px] h-[50px] hover:border-[#4e77e7] w-[330px] md:w-[330px] xl:w-[400px] rounded-xl px-4 text-white shadow-xl	"
        ...
        <textarea
          className="bg-[#343838] border hover:border-[2px] h-[120px] hover:border-[#4e77e7] w-[330px] lg:w-[670px] xl:w-[800px] rounded-xl px-4 p-5 text-white shadow-xl"
          placeholder="Email address"
          style={{ outline: "none" }}
        ></textarea>
        <div className="pt-10">
