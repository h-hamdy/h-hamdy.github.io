    ...
    <>
      ...
      <div className="h-[95%] overflow-y-auto lg:pb-40">
        <div className="flex lg:px-10 px-6 text-gray-200 text-center overflow-y-auto text-sm lg:text-md lg:tracking-wider">
          Hello! I am Houssam Hamdy, a Software Engineer graduated from 1337.
          Passionate about solving real-world challenges, I thrive in
          collaborative environments and enjoy contributing to both frontend and
          backend development in group projects. I'm highly motivated by
          problem-solving and constantly driven to create innovative solutions
          that address complex issues. I am always eager to apply my skills and
          creativity to new opportunities that make a positive impact.
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-10 lg:pl-28 pl-10 px-6 py-6 text-white">
            <div className="flex gap-[15px]">
              ...
              <div>
                <div className="text-sm lg:text-md">
                  1337 (42 Network), Benguerir
                </div>
                <div className="text-[11px] text-gray-400">
                  November 2021 - 2024
                </div>
                <div className="lg:text-sm text-xs text-gray-300 pt-[10px]">
                  Student at 1337 School, currently at level{" "}
                  <span className="text-white text-sm">13.74</span>, with strong
            ...
            <div className="flex gap-[15px]">
              ...
              <div>
                <div className="text-sm lg:text-md">
                  UM6P - Mohammed VI Polytechnic University · Internship
                </div>
                <div className="text-[11px] text-gray-400">Janvier 2024</div>
                <div className="lg:text-sm text-xs text-gray-300 pt-[10px]">
